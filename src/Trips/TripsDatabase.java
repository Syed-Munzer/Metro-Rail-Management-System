...
public class TripsDatabase 
{
    ...
    {
        String insert="INSERT INTO `trips`(`ID`, `Start`, `Destination`, `DepartureTime`, `ArrTime`, `Date`, `BookedSeats`, `Price`, `Driver`, `Train`) VALUES ('"+t.getID()+"','"+t.getStart()+"','"+t.getDestination()+"','"+t.getDepartureTime()+"','"+t.getArrivalTime()+"','"+t.getDate()+"','"+t.getBookedSeats()+"','"+t.getPrice()+"','"+t.getDriver().getID()+"','"+t.getTrain().getID()+"')";
    ...
    {
        String update = "UPDATE `trips` SET `Start`='"+t.getStart()+"',`Destination`='"+t.getDestination()+"',`DepartureTime`='"+t.getDepartureTime()+"',`ArrTime`='"+t.getArrivalTime()+"',`Date`='"+t.getDate()+"',`Price`='"+t.getPrice()+"',`Driver`='"+t.getDriver().getID()+"',`Train`='"+t.getTrain().getID()+"' WHERE `ID` = "+t.getID()+" ;";
    ...
    public static void BookTrip(Trip t, String ID, String num, Database database) throws SQLException
    {
        String insert="INSERT INTO `trip "+t.getID()+" passengers`(`Passenger`, `Tickets`) VALUES ('"+ID+"','"+num+"')";
        database.getStatement().execute(insert);
